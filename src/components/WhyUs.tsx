		...
		<SectionWrapper>
			<div className="py-28">
				...
				<div className="flex items-center py-16">
					<div className="grid grid-cols-2 gap-10 gap-y-4 max-w-[800px]">
						{whyUsData.map((data, index) => (
							<div
								key={index}
								className="flex flex-col items-start my-10 max-w-[330px]"
							>
								...
								<div>
									<h3 className="text-[#101828] text-2xl font-semibold mb-3">
										{data.title}
									</h3>
					...
					<div className="flex items-end relative justify-end flex-1">
